...
{
    /// <inheritdoc />
    public partial class DBmodelsChanges01 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TripId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TravellerId = table.Column<string>(type: "TEXT", nullable: false),
                    DatumStart = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DatumEnd = table.Column<DateTime>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trip_AspNetUsers_TravellerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stories_Destinations_DestinationId",
                        column: x => x.DestinationId,
                        principalTable: "Destinations",
                        principalColumn: "DestinationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stories_Trip_TripId",
                        column: x => x.TripId,
                        principalTable: "Trip",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stories_DestinationId",
                table: "Stories",
                column: "DestinationId");

            migrationBuilder.CreateIndex(
                name: "IX_Stories_TripId",
                table: "Stories",
                column: "TripId");

            migrationBuilder.CreateIndex(
                name: "IX_Trip_TravellerId",
                table: "Trip",
                column: "TravellerId");
        }
